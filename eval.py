...
output_path = '/home2/LiuY/Code/Web-GitHub/CHiME-7-baseline-main/baseline_results'

######## Config for the CHiME-5 dataset of the UDASE task ########

# path to the input data
chime5_input_path = '/home2/LiuY/Code/Web-GitHub/CHiME-7-baseline-main/baseline/dataset_loaders/dataset/CHiME_audio_segement'
# subsets to process
...
# path to the input data
reverberant_librichime5_input_path = '/home2/LiuY/Code/Web-GitHub/CHiME-7-baseline-main/baseline/dataset_loaders/dataset/reverberant-LibriCHiME-5'
...
# path to the input data
librimix_input_path = '/home2/LiuY/Code/Web-GitHub/CHiME-7-baseline-main/baseline/dataset_loaders/dataset/LibriMix/Libri3Mix'
# subsets to process and evaluate
